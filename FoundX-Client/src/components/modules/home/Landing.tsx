...
const Landing = () => {
  ...
  return (
    <div className='h-[calc(100vh-64px)] bg-[url("/Home-Banner.jpg")] bg-cover bg-center'>
      <div className="h-[calc(100vh-64px)] bg-black/50 backdrop-blur-sm">
        <div className="pt-32 max-w-xl flex-1 mx-auto">
          <div className="text-center mb-3">
            <h1 className="text-6xl font-extrabold">FoundX</h1>
          </div>
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="flex-1 mx-4">
              <Input
                ...
                size="lg"
                startContent={
                  <SearchIcon className="pointer-events-none flex-shrink-0 text-default-600" />
                }
                type="text"
              />
            </div>
